...
//
//
//                        // 2. Citizen Feedback (Use ** to match ID reliably)
//                        .requestMatchers(HttpMethod.PUT, "/api/grievances/*/feedback").hasAnyAuthority("CITIZEN", "ROLE_CITIZEN")
//
//                        // 3. Admin/Officer Actions (Use ** for IDs)
//                        .requestMatchers(HttpMethod.PUT, "/api/grievances/**/reopen").hasAnyAuthority("CITIZEN", "ROLE_CITIZEN") // Allow Citizen to Reopen
