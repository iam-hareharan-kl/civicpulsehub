...
//           alert(`Error: ${err.status} - ${err.error?.message || 'Check Console'}`);
//         }
//       });
//   }
...
//     if (!g.expectedCompletionDate || !g.resolvedAt) return true; // Default to true if no SLA set
...
import { Component, OnInit, ChangeDetectorRef, Inject, PLATFORM_ID } from '@angular/core'; // 1. Add Imports
import { CommonModule, isPlatformBrowser } from '@angular/common'; // 2. Add Import
import { FormsModule } from '@angular/forms';
import { GrievanceService } from '../service/grievance';
import { AuthService } from '../service/auth-service';
import { Router } from '@angular/router';
